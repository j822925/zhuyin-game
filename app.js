...
$('app').innerHTML=`<header><a class="brand" href="./${demo?'?demo=1':''}"><span class="brand-icon">ㄅ</span>注音探險島</a><div class="top-actions"><span id="connection" role="status">讀取老師任務…</span><a href="teacher.html">老師專區 ↗</a></div></header>
